...
.mdx-notion table {
  ...
  border: 1px solid color-mix(in srgb, var(--color-textColor) 12%, transparent);
...
.mdx-notion th {
  ...
  border-bottom: 1px solid color-mix(in srgb, var(--color-textColor) 12%, transparent);
}
...
.mdx-notion td {
  padding: 0.75rem 1rem;
  vertical-align: top;
  border-bottom: 1px solid color-mix(in srgb, var(--color-textColor) 8%, transparent);
}

article tbody tr:last-child td,
.mdx-notion tbody tr:last-child td {
  border-bottom: none;
}

article tbody tr:nth-child(even),
.mdx-notion tbody tr:nth-child(even) {
  background-color: color-mix(in srgb, var(--color-accent) 3%, transparent);
}

article tbody tr:hover,
.mdx-notion tbody tr:hover {
...
.post-nav-link {
  ...
  border-color: color-mix(in srgb, var(--color-textColor) 8%, transparent);
  background-color: color-mix(in srgb, var(--color-bgColor) 98%, var(--color-popover-bg));
}

.post-nav-link:hover {
  border-color: color-mix(in srgb, var(--color-accent) 50%, transparent);
  background-color: color-mix(in srgb, var(--color-accent) 4%, var(--color-bgColor));
